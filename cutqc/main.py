...
class CutQC:
    ...
    def __init__(self, name, circuit, cutter_constraints, verbose):
        ...
        self.times = {}
        self.tmp_data_folder = "cutqc/tmp_data2"
    ...
    def evaluate(self, eval_mode, num_shots_fn, noise_model_fn = None, backend_config_fn = None):
        """
        ...
        self.backend_config_fn = backend_config_fn
    ...
    def verify(self):
        ...
        return reconstructed_prob, self.approximation_error
    ...
    def _run_subcircuits(self):
        ...
        run_subcircuit_instances(
            ...
            data_folder=self.tmp_data_folder,
            noise_model_fn=self.noise_model_fn,
            backend_config_fn=self.backend_config_fn
        )
