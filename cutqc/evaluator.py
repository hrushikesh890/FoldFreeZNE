...
from helper_functions.rzne import get_esp
...
def run_subcircuit_instances(
    subcircuits, subcircuit_instances, eval_mode, num_shots_fn, data_folder, noise_model_fn, backend_config_fn,
):
    """
    ...
    for subcircuit_idx in subcircuit_instances:
        ...
        '''if eval_mode == 'qasm_noisy' and subcircuit_idx == 1:
                eval_mode = 'sv'''
        ...
        pickle.dump(
            {
                ...
                "noise_model_fn": noise_model_fn,
                "backend_config_fn": backend_config_fn,
            },
